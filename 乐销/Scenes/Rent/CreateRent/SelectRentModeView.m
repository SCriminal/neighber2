...
@interface SelectRentModeView ()<UIPickerViewDelegate,UIPickerViewDataSource>
...
@implementation SelectRentModeView
...
- (NSMutableArray *)aryDatas0{
    if (!_aryDatas0) {
        //       1整租 2合租 3出售
        _aryDatas0 = @[@"整租",@"合租",@"出售"].mutableCopy;
    }
    return _aryDatas0;
}
