...
@implementation SecurityDetailTopView
#pragma mark 懒加载
- (UILabel *)problem{
    if (_problem == nil) {
...
- (void)resetViewWithModel:(ModelCommunityServiceList *)model{
    ...
    //刷新view
    [self.problem fitTitle:@"故障描述" variable:0];
    self.problem.leftTop = XY(W(30),W(25));
...
@implementation SecurityDetailStatusView
#pragma mark 懒加载
- (UILabel *)progress{
    if (_progress == nil) {
...
- (void)resetViewWithModel:(ModelCommunityServiceList *)model{
    ...
    self.progress.leftTop = XY(W(30), self.title.bottom+W(25));
...
@implementation SecurityDetailAddCommentView
#pragma mark 懒加载
- (UILabel *)comment{
    if (_comment == nil) {
...
@implementation SecurityDetailCommentDetailView
#pragma mark 懒加载
- (UILabel *)comment{
    if (_comment == nil) {
        _comment = [UILabel new];
